...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    try{
      ...
      message.reply({embeds: [new MessageEmbed().setColor(client.color).setDescription(`<:IconTick:1229080348277604456> | Successfully UnMuted <@${member.user.id}> From Voice!`)]})
    }catch(err){
